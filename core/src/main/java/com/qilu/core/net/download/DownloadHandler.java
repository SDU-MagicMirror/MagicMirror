package com.qilu.core.net.download;

import android.os.AsyncTask;

import com.qilu.core.net.RestCreator;
...
public class DownloadHandler {
    ...
    public DownloadHandler(String url, WeakHashMap<String, String> params, IRequest request,
